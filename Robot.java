...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    System.out.println("calculated " + (shooter.shooterWheelLinearVelocityToMotorVelocity(shooter.calculatedVelocity) * 1.006));
  ...
  public void teleopPeriodic() {
    ...
    // System.out.println("calculated velocity: " + shooter.shooterWheelLinearVelocityToMotorVelocity(shooter.calculatedVelocity));
    ...
    if (intakeBoolean) {
      intake.intakeMotor.set(-0.7);
    } else {
      intake.intakeMotor.set(0.0);
    }
    //shooter.masterShooterMotor.set(0.87);

    // // intake angle
    // if (Constants.stick.getRawButton(11)) { // intake angle down
    //   intake.intakeAngleMotor.set(-0.35);
    ...
    // hood
    // if (!shooter.shooting && !shooter.dumpShot) {
    ...
    //   climberSpeed = 0.0;
    // }
    // climber.centerClimberHeightMotor.set(ControlMode.PercentOutput, climberSpeed);

    /////////////////////////////////////////////////////////////////
    /////////////////////////////////////////////////////////////////

    // if(Constants.stick.getRawButtonPressed(3)){
    //   shooterSpeed1 -= 0.005;
    // }
    // if(Constants.stick.getRawButtonPressed(4)){
    //   shooterSpeed1 += 0.005;
    // }

    // //System.out.println("shooterSpeed1: " + shooterSpeed1);
    // System.out.println("distance from target: " + shooter.getXDistanceFromCenterOfHub(NetworkTableInstance.getDefault().getTable("limelight").getEntry("ty").getDouble(0.0)));
    // // ~ 92.0 inches from 18.0 inches closer from the center of the hub according to method
    // // shooter speed .4125
    // shooter.masterShooterMotor.set(ControlMode.PercentOutput, shooterSpeed1);
    // if(shooter.masterShooterMotor.getSelectedSensorVelocity() > shooterSpeed1 * 22201.15 * 1.006){
    //   intake.indexerMotor.set(-0.4);
    // } else {
    ...
    // && (!ballCountBoolean) && (timer.get() > 0.2)) { // can double-check this
    // number
